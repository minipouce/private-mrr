...
> [!NOTE]
> **Every figure in these screenshots is fabricated.** The project names are the
> author's real products, which makes the screenshots concrete — but the revenue,
> subscriber counts and growth numbers are generated by the demo seed
> (`npm run seed`). None of it reflects actual business performance.
...
Payments play an actual cash-register *cha-ching* — a separate Android
