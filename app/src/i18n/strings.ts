...
export const en = {
  ...
  compedSubscribers: 'comped',
  onPromo: 'on promo',
  atRisk: 'AT RISK',
  paymentFailing: 'payment failing',
  ...
  churnPerMonth: 'churn/mo',
  newPerMonth: 'new/mo',
  projectedMrr: 'projected MRR',
  measuredOver: 'measured over {count} mo, {events} cancellations',
  allProjects: 'all projects',
  thinHistory: 'too little history to extrapolate',
...
export const fr: Strings = {
  ...
  compedSubscribers: 'offerts',
  onPromo: 'en promo',
  atRisk: 'À RISQUE',
  paymentFailing: 'paiement en échec',
  ...
  churnPerMonth: 'churn/mois',
  newPerMonth: 'nouveaux/mois',
  projectedMrr: 'MRR projeté',
  measuredOver: 'mesuré sur {count} mois, {events} résiliations',
  allProjects: 'tous projets',
  thinHistory: 'trop peu d\u2019historique pour extrapoler',
